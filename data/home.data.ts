...
import { Lang } from '@/data/global';
import { HomeHeaderProps } from '@/data/headers';
import { HomeIntroductionContent } from '@/data/introductions';
import { HomeFeaturedProjectContent } from '@/data/sections';
